...
var me_user1=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('سامي ديزاين')").addClass('stl1');
	...
	$("#users .uzr.stl1 .c-flex.fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://www.samidesign.net/">يا كل حياتي انت</div>');
        $("#users .uzr span.u-topic:contains('سامي ديزاين')").after('<img id="mystory1" class="My_vedio1" title="ستوري" src="https://i.ibb.co/47VS4nY/image.png">');
        ...
        $("div#users .uzr:contains('سامي ديزاين') .My_vedio1").click(function(){
        $("#movon1").show();
