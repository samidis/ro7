...
#users .uzr.sami1 .fl.muted.fa {
  margin-left: -4px!important;
  float: left;
}
#users .uzr.sami1 .fr.minix.tago {
  padding-right: 0px !important;
}
#users .uzr.sami1 .u-topic {
  margin-left: 5px;
}
#users .uzr.sami1 .dham_star1 {
width: 100px;
margin-top: -22px;
margin-left: -23px;
}
...
var l_itvdham=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('سامي ديزاين')").addClass('sami1');
        $("#users .uzr.sami1 .fitimg.fl.u-pic").append('<img class="dham_star1" src="https://up6.cc/2023/02/167579738513671.png">');
		$("#users .uzr.sami1 span.corner.u-topic.fl").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://i.ibb.co/47VS4nY/image.png">');
        $("#users .uzr.sami1 span.usid.fr, #users .uzr.sami1 fr.co.nosel").hide(); 
        $("#upro").before('<div id="movon1" onclick="$(this).hide().html(``);" class="moveon1" style="display:none;width:100%;height:100%;z-index:999999;position: fixed;left: 0px;top: 0px;background-color: rgba(0, 0, 0, 0.6);">');
