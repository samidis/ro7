...
#users .uzr.stl2 .corner.u-topic.fl {
  margin-left: -4px!important;
  float: left;
}
...
var zizo=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr.stl2 .corner.u-topic.fl").append('<img class="My_star1" src="https://i.ibb.co/5G9Ttb7/10.gif">');
	$("#users .uzr.stl2 .corner.u-topic.fl").append('<img class="My_tsor" src="https://i.ibb.co/ThKHx1N/image.png">');
	$("#users .uzr.stl2 .corner.u-topic.fl").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://1des.net/">رَجُلٌ فَقَدَ "دِفْْءَ" إِمْرَأَةٍ فَـ "تَجَمَّدْ</div>');
