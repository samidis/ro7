...
#users.jnoon1 fr.co.nosel{border-radius: 0 10px 0 10px!important;transform:rotate(20deg);margin-top:2px!important}
...
$("style").last().append(`
#users .uzr.stl1 .fitimg.fl.u-pic {
...
#users .uzr.stl1 usid.fr {
  margin-right: 324px;
  margin-top: 24px;
  margin-left: 0px;
}
#users .uzr.stl1 fr.co.nosel {
...
#users .uzr.stl1 .corner.u-topic.fl {
  margin-left: -4px!important;
  float: left;
}
#users .uzr.stl1 .fl.muted.fa {
...
var me_user1=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr.stl1 .corner.u-topic.fl").append('<img class="My_star1" src="https://i.ibb.co/5G9Ttb7/10.gif">');
	$("#users .uzr.stl1 .corner.u-topic.fl").append('<img class="My_tsor" src="https://i.ibb.co/ThKHx1N/image.png">');
	$("#users .uzr.stl1 .corner.u-topic.fl").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://www.samidesign.net/">يا كل حياتي انت</div>');
        ...
        $("#users .uzr.stl1 usid.fr, #users .uzr.stl1 fr.co.nosel").hide(); 
...
#users .uzr.stl2 usid.fr {
  margin-right: 324px;
  margin-top: 24px;
  margin-left: 0px;
}
#users .uzr.stl2 fr.co.nosel {
  transform: rotate(90deg);
  margin-top: -60px !important;
  margin-right: 282px;
}
...
var zizo=setInterval(function(){
	...
	$("#users .uzr.stl2 .c-flex fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://1des.net/">رَجُلٌ فَقَدَ "دِفْْءَ" إِمْرَأَةٍ فَـ "تَجَمَّدْ</div>');
        ...
        $("#users .uzr.stl2 usid.fr, #users .uzr.stl2 fr.co.nosel").hide(); 
