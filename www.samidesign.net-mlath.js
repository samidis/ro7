...
@property --angle {
	...
	initial-value: 0deg;
	inherits: false;
}</style>`).insertBefore("body"),newstyle=!1;var itv=setInterval(function(){null!=myid&&!1==newstyle&&(clearInterval(itv),newstyle=!0,$("#mic").append("<input id=\"rdark_mod\" class=\"r_mod\" type=\"checkbox\" style=\"display:none;\">"),$("#rdark_mod").click(()=>{$(".one5").toggleClass("one6")}))},1e3);$("style").last().append(`
...
@property --angle {
	...
	initial-value: 0deg;
	inherits: false;
}</style>`).insertBefore("body"),newstyle1=!1;var itv1=setInterval(function(){null!=myid&&!1==newstyle1&&(clearInterval(itv1),newstyle1=!0,$("#mic").append("<input id=\"rdark_mod1\" class=\"r_mod1\" type=\"checkbox\" style=\"display:none;\">"),$("#rdark_mod1").click(()=>{$(".kbar5").toggleClass("kbar6")}))},1e3);$("style").last().append(`
...
`);var r_kbar=!1;setInterval(function(){"17fdc8ef597x92764b87-x-mu6pwv"==myroom?!1==r_kbar&&(r_kbar=!0,$("#mic").addClass("kbar3"),$("#rdark_mod1").addClass("kbar4"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").addClass("kbar5"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").addClass("kbar6")):!0==r_kbar&&(r_kbar=!1,$("#mic").removeClass("kbar3"),$("#rdark_mod1").removeClass("kbar4"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").removeClass("kbar5"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").removeClass("kbar6"))},10);var _0x3f13=["body","insertBefore","<style>#mic4 {margin-right: 8px !important;}.room.borderg.hand.nosel.fl.efOiAhhNdL2 .corner.fa.fa-user.label.uc.fa-microphone.label-danger {  letter-spacing: 1px;  -webkit-text-fill-color: #000;  background-image: url(https://i.ibb.co/rm5vwJS/444444erwe.png);  padding: 0px !important;border-radius: 50px !important;}.room.borderg.hand.nosel.fl.efOiAhhNdL2 {display: inline-block;background-image: linear-gradient(-225deg, rgb(255, 250, 202) 0%, rgba(255, 0, 143, 0) 29%, rgba(151, 101, 127, 0.04) 67%, rgb(255, 242, 173) 100%);border-radius: 0px 0px 15px 15px;}room.borderg.hand.nosel.fl.efOiAhhNdL2 .dots.mini.u-msg{text-align:center;background-size:200% auto;-webkit-background-clip:text;-webkit-text-fill-color:#ff9b0000;background-image:-webkit-linear-gradient(75deg,rgb(0 0 0 / 53%) 25%,#ff9b00 25%,#000000 50%,#ff9b00 50%,#ff006600 75%)}.room.borderg.hand.nosel.fl.efOiAhhNdL2 .fitimg.u-pic.borderg{border-radius:100px;border:2px solid #ffcb50;padding-top:30px}.room.borderg.hand.nosel.fl.efOiAhhNdL2 .u-topic.dots{font-weight:900;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #ffb913 67%, #aaa 100%);background-size:300% 300%;-webkit-background-clip:text;-webkit-text-fill-color:#0000;line-height:2;animation:grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite}@keyframes grad{0%{background-position:14% 0}50%{background-position:87% 100%}100%{background-position:14% 0}</style>","17ef32d2603xebed46b3-xfg0v0d","#d2 .roomh[onclick=\"rjoin('","')\"]{background-image: linear-gradient(-225deg, #000 0%, #000 29%, #ffb913 67%, #aaa 100%);background-size: 220% auto;animation: textclip 5s linear infinite;padding: 2px!important;border-radius: 50px !important;border: 1px solid #0000;}","append","style:eq(0)","#upro .roomh[onclick=\"rjoin('","')\"]{background-image: linear-gradient(-225deg, #000 0%, #000 29%, #ffb913 67%, #aaa 100%);background-size: 220% auto;animation: textclip 5s linear infinite;border-radius: 50px !important;border: 1px solid #0000;}","<style>\t#mic.mlok3 .mic{    border:2px solid;    border-image: linear-gradient(var(--angle),#e3bb43 0%,#000 29%,#ffbf00 67%,#020202 100%) 1;\tanimation:5s rotate linear infinite;    --angle:0deg;    background-color:#e3e3e3;    border-radius:5px!important;    margin:2px;    margin-top:1px;    box-shadow:inset 0 0 0 rgb(0 0 0 / 8%),0 0 1px #fff;height:48px}    @keyframes rotate{to{--angle:360deg}}@property --angle{syntax:\"<angle>\";initial-value:0deg;inherits:false}</style>","<input id=\"rdark_mod3\" class=\"r_mod3\" type=\"checkbox\" style=\"display:none;\">","#mic","mlok6","toggleClass",".mlok5","click","#rdark_mod3","#users.mlok5 .inroom.uzr{border-radius:5px;border:1px solid #fffefe;border-bottom:1px solid #fffefe}#users.mlok5 .inroom.uzr img.ustat {width: 54px !important;border-radius: 0px 50px 50px 50px !important;height: 52px !important;margin-top: -1px;min-height: 0% !important;}#users.mlok5 .inroom.uzr .fitimg.u-pic {box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #a21f1f;border: 1px solid #fff;border-radius: 50px;margin-top: -1px;z-index: 0;margin-left: -53px;}#d2.mlok5 .uzr .fitimg.u-pic{border: 1px solid #fff;margin-top: 2px;border-radius: 50px;box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #ffa700;height: 52px !important;}#users.mlok5 .inroom.uzr .u-msg{max-height: 25px !important;text-align:center;background-size:200% auto;-webkit-background-clip:text;-webkit-text-fill-color:#0000;background-image: linear-gradient(225deg,#000 0%,#000 29%,#972d2d 67%,#8e8e8e 100%);}#users.mlok5 .inroom.uzr span.uhash{text-transform:uppercase;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #ffb913 67%, #aaa 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}#users.mlok5 .inroom.uzr img.co{transform:rotate(20deg);margin-top:2px!important}#d2.mlok5 .uzr.d-flex.mm{background-image:linear-gradient(-225deg,#0000 0,#0000 29%,#9191910d 67%,#d7d7d7 100%);border-radius:5px;border:1px solid #fffefe;border-bottom:1px solid #fffefe}#rdark_mod3.r_mod3.mlok4 {-webkit-appearance: none;outline: none;width: 35px;height: 35px;border-radius: 50px;position: relative;transition: 0.4s;background: url(\"https://e.top4top.io/p_2462r4jy21.png\")no-repeat center #212121;background-size: 25px;cursor: pointer;margin-top: 8px !important;}#rdark_mod3.r_mod3.mlok4:checked {background: url(\"https://f.top4top.io/p_2462lelhr2.png\")no-repeat center #000;background-size: 25px;}#rdark_mod3.r_mod3.mlok4 {display: flex !important;}.mlok6{background-color: #16202a;transition: background-color 0.5s ease;}#users.mlok6 .uzr {background-color: #16202a !important;}#dpnl.mlok6 .nosel.ninr.fl.uzr.label.bg {background-color: #16202a;}#settings.mlok6 .borderg.corner {background-color: #16202a !important;border: 0px solid #f4f4f4;}#d2.mlok6 .u-msg.break {color: #d7d7d7 !important;}#d2.mlok6 .nosel.u-topic.dots.hand {color: #fff !important;background-color: rgba(255, 241, 214, 0) !important;}#d2.mlok6 .uzr.d-flex.mm.pmsgc {background-color: #16202a !important;border-bottom: 1px solid #16202a !important;}#d2.mlok6 .bdel.corner.btn.minix.btn-primary.fa.fa-times {  background-color: #16202a !important;  border: 1px solid #2b3a48;}#settings.mlok6 .label-primary {background-color: #16202a !important;}#rooms.mlok6 .label-primary {background-color: #16202a !important;}#rooms.mlok6 .nosel.d-flex.room {background-color: #16202a;}#users.mlok6 .nosel.ninr.fl.uzr.label.bg {background-color: #16202a !important;}#wall.mlok6 .uzr.d-flex.mm {background-color: #16202a;border-bottom: 1px solid #425466 !important;}#wall.mlok6 .tablebox.light.d-flex {  background-color: #3d4e60;#wall.mlok6 .fitimg.u-pic.borderg {  border-radius: 50px;  border: 0px solid #16202a;  height: 52px !important;#wall.mlok6 .u-msg.break { color: rgb(255, 255, 255) !important;}#wall.mlok6 .nosel.u-topic.dots.hand {  color: rgb(255, 255, 255) !important;  background-color: rgb(57, 57, 57);}#wall.mlok6 .bdel.corner.btn.minix.btn-primary.fa.fa-times {  background-color: #16202a !important;  border: 1px solid #2b3a48;#wall.mlok6 .breply.corner.btn.minix.btn-primary.fa.fa-comments {  background-color: #16202a !important;  border: 1px solid #2b3a48;#d0.mlok6 .label-primary {background-color: #16202a;}#settings.mlok6 .borderg.corner {background-color: #16202a !important;border: 0px solid #f4f4f4;}#d2.mlok6 {background-color: #16202a !important;}#settings.mlok6 .label-primary, .btn-primary, .bg-primary {background-color: #16202a;}#d0.mlok6 .label-primary, .btn-primary {background-color: #16202a;}#muteall.mlok6 {background-color: mediumseagreen !important;}#rooms.mlok6 .label-primary, .btn-primary {background-color: #16202a;}#users.mlok6 .tbox {background-color: #3d4e60;}#room.mlok6 #mic {background-color: #16202a;}#room.mlok6 #mic .mic, #muteall {background-color: #16202a;}#room.mlok6 .break {background-color: #16202a;}#room.mlok6 .tablebox.d-flex.footer.fl.light {background-color: #3d4e60;}#users.mlok6 .inroom.uzr .u-topic {background-color: rgba(255, 241, 214, 0) !important;color: rgb(215, 215, 215) !important;}#users.mlok6 .inroom.uzr{border-radius:5px;border-bottom: 1px solid #45586a;border: 1px solid #334353;}#users.mlok6 .inroom.uzr img.ustat {width: 54px !important;border-radius: 0px 50px 50px 50px !important;height: 52px !important;margin-top: -1px;min-height: 0% !important;}#users.mlok6 .inroom.uzr .fitimg.u-pic {border-radius: 50px;margin-top: -1px;z-index: 0;margin-left: -53px;}#d2.mlok6 .uzr .fitimg.u-pic{border: 1px solid #344251;margin-top:2px;border-radius:50px;height: 52px !important;}#users.mlok6 .inroom.uzr .u-msg{max-height: 25px !important;text-align:center;background-size:200% auto;-webkit-background-clip:text;-webkit-text-fill-color:#0000;background-image: linear-gradient(225deg,#000 0%,#000 29%,#972d2d 67%,#8e8e8e 100%);}#users.mlok6 .inroom.uzr span.uhash{text-transform:uppercase;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #ffb913 67%, #aaa 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}#users.mlok6 .inroom.uzr img.co{transform:rotate(20deg);margin-top:2px!important}#d2.mlok6 .uzr.d-flex.mm{background-color: #fafafa00 !important;border-bottom: 0px solid #334353 !important;background-image:linear-gradient(-225deg,#0000 0,#0000 29%,#9191910d 67%,#d7d7d7 100%);border-radius:5px;border:1px solid #334353;border-bottom:1px solid #334353}#d2.mlok6 .hmsg {background-color: #16202a;}","last","style","mlok4","addClass","mlok5","#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall","mlok3","removeClass",""],_0xd3a8=[_0x3f13[0],_0x3f13[1],_0x3f13[2],_0x3f13[3],_0x3f13[4],_0x3f13[5],_0x3f13[6],_0x3f13[7],_0x3f13[8],_0x3f13[9],_0x3f13[10],_0x3f13[11],_0x3f13[12],_0x3f13[13],_0x3f13[14],_0x3f13[15],_0x3f13[16],_0x3f13[17],_0x3f13[18],_0x3f13[19],_0x3f13[20],_0x3f13[21],_0x3f13[22],_0x3f13[23],_0x3f13[24],_0x3f13[25],_0x3f13[26]];$(`${_0x3f13[27]}${_0xd3a8[2]}${_0x3f13[27]}`)[_0xd3a8[1]](_0xd3a8[0]);var rid=_0xd3a8[3];$(_0xd3a8[7])[_0xd3a8[6]](`${_0x3f13[27]}${_0xd3a8[4]}${_0x3f13[27]}${rid}${_0x3f13[27]}${_0xd3a8[5]}${_0x3f13[27]}`),$(_0xd3a8[7])[_0xd3a8[6]](`${_0x3f13[27]}${_0xd3a8[8]}${_0x3f13[27]}${rid}${_0x3f13[27]}${_0xd3a8[9]}${_0x3f13[27]}`),$(`${_0x3f13[27]}${_0xd3a8[10]}${_0x3f13[27]}`)[_0xd3a8[1]](_0xd3a8[0]),newstyle3=!1;var itv3=setInterval(function(){null!=myid&&!1==newstyle3&&(clearInterval(itv3),newstyle3=!0,$(_0xd3a8[12])[_0xd3a8[6]](_0xd3a8[11]),$(_0xd3a8[17])[_0xd3a8[16]](()=>{$(_0xd3a8[15])[_0xd3a8[14]](_0xd3a8[13])}))},1e3);$(_0xd3a8[20])[_0xd3a8[19]]()[_0xd3a8[6]](`${_0x3f13[27]}${_0xd3a8[18]}${_0x3f13[27]}`);var r_mlok=!1;setInterval(function(){myroom==_0xd3a8[3]?!1==r_mlok&&(r_mlok=!0,$(_0xd3a8[17])[_0xd3a8[22]](_0xd3a8[21]),$(_0xd3a8[24])[_0xd3a8[22]](_0xd3a8[23]),$(_0xd3a8[24])[_0xd3a8[22]](_0xd3a8[13]),$(_0xd3a8[12])[_0xd3a8[22]](_0xd3a8[25])):!0==r_mlok&&(r_mlok=!1,$(_0xd3a8[17])[_0xd3a8[26]](_0xd3a8[21]),$(_0xd3a8[24])[_0xd3a8[26]](_0xd3a8[23]),$(_0xd3a8[24])[_0xd3a8[26]](_0xd3a8[13]),$(_0xd3a8[12])[_0xd3a8[26]](_0xd3a8[25]))},10),$(`<style>#mic.jil3 .mic {border: 2px solid;border-image: linear-gradient(var(--angle), #e34385 0%, #000000 29%, #ff75a2 67%, #020202 100%) 1;animation: 5s rotate linear infinite;--angle: 0deg;background-color: #e3e3e3;border-radius: 5px !important;margin: 2px;margin-top: 1px;box-shadow: inset 0 0px 0px rgb(0 0 0 / 8%), 0 0px 1px #ffffff;height: 48px;}@keyframes rotate {
	to {
		--angle: 360deg;
	}
}
@property --angle {
	...
	initial-value: 0deg;
	inherits: false;
}</style>`).insertBefore("body"),$("style").last().append(`
...
@property --angle {
	...
	initial-value: 0deg;
	inherits: false;
}</style>`).insertBefore("body"),newstyle2=!1;var itv2=setInterval(function(){null!=myid&&!1==newstyle2&&(clearInterval(itv2),newstyle2=!0,$("#mic").append("<input id=\"rdark_mod2\" class=\"r_mod2\" type=\"checkbox\" style=\"display:none;\">"),$("#rdark_mod2").click(()=>{$(".north5").toggleClass("north6")}))},1e3);$("style").last().append(`
...
`);var r_north=!1;setInterval(function(){"18330b950ffx9914ab32xqjvcmr"==myroom?!1==r_north&&(r_north=!0,$("#users").addClass("north1"),$("#d2").addClass("north2"),$("#mic").addClass("north3"),$("#rdark_mod2").addClass("north4"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").addClass("north5"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").addClass("north6")):!0==r_north&&(r_north=!1,$("#users").removeClass("north1"),$("#d2").removeClass("north2"),$("#mic").removeClass("north3"),$("#rdark_mod2").removeClass("north4"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").removeClass("north5"),$("#room, #d2, #d0, #rooms, #users, #wall, #dpnl, #settings, #chats, #mic #muteall ").removeClass("north6"))},10),$(`<style>#mic.kium3 .mic {border: 2px solid;border-image: linear-gradient(var(--angle), #328820 0%, #000 29%, #91ff73 67%, #020202 100%) 1;animation: 5s rotate linear infinite;--angle: 0deg;background-color: #e3e3e3;border-radius: 5px !important;margin: 2px;margin-top: 1px;box-shadow: inset 0 0px 0px rgb(0 0 0 / 8%), 0 0px 1px #ffffff;height: 48px;}@keyframes rotate {
	to {
		--angle: 360deg;
	}
}
...
border-radius:5px;
border:1px solid #fffefe;
border-bottom:1px solid #fffefe}`);var r_kium=!1;setInterval(function(){"1833e52886cx17cb8825xrbhosg"==myroom?!1==r_kium&&(r_kium=!0,$("#users").addClass("kium1"),$("#d2").addClass("kium2"),$("#mic").addClass("kium3")):!0==r_kium&&(r_kium=!1,$("#users").removeClass("kium1"),$("#d2").removeClass("kium2"),$("#mic").removeClass("kium3"))},10),$(`<style>.nosel.d-flex.room.r1837d95c1a9x54fb93-xaps7hv .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
letter-spacing: 1px;
...
margin-top: -2px;
margin-left: 5px;}
@keyframes textclip {to {background-position: 200% center;}}</style>`).insertBefore("body");var rid="1837d95c1a9x54fb93-xaps7hv";$("style:eq(0)").append(`#d2 .roomh[onclick="rjoin('${rid}')"]{animation: textclip 5s linear infinite;
...
color: transparent !important;
background-size: 100% 100%;
margin-top: -3px;}`),$("style:eq(0)").append(`#upro .roomh[onclick="rjoin('${rid}')"]{padding: 2px !important;
...
border-radius: 15px 0px 15px 0px;
border:1px solid #fffefe;
border-bottom:1px solid #fffefe}`);var r_dl3=!1;setInterval(function(){"1837d95c1a9x54fb93-xaps7hv"==myroom?!1==r_dl3&&(r_dl3=!0,$("#users").addClass("dl31"),$("#d2").addClass("dl32"),$("#mic").addClass("dl33")):!0==r_dl3&&(r_dl3=!1,$("#users").removeClass("dl31"),$("#d2").removeClass("dl32"),$("#mic").removeClass("dl33"))},10);